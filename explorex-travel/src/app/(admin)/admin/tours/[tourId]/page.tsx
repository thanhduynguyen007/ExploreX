    ...
    <div className="space-y-6">
      <section className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
        <div className="space-y-3">
          <Link href="/admin/tours" className="inline-flex items-center gap-2 text-[14px] font-bold text-[#5a8cff]">
          ...
          <div>
            ...
            <p className="mt-2 text-[15px] text-[#6b7280]">
              Theo dõi thông tin chi tiết của tour từ dữ liệu thật trong bảng <span className="font-semibold text-[#202224]">tour</span>.
            </p>
          </div>
        </div>
      ...
      <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        ...
        <DetailCard label="Nhà cung cấp" value={tour.tenNhaCungCap ?? tour.maNhaCungCap} />
