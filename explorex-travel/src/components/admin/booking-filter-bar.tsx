...
export function BookingFilterBar({
  ...
  useEffect(() => setBookingStatus(initialBookingStatus), [initialBookingStatus]);
  useEffect(() => setPaymentStatus(initialPaymentStatus), [initialPaymentStatus]);
  ...
  return (
    <div className="space-y-3">
        ...
        <div className="grid gap-3 xl:grid-cols-[1fr_1fr_1.2fr_auto]">
          <FilterDropdown
            ...
            onChange={(value) => {
              ...
              pushParams({ bookingStatus: value });
            }}
          />
          ...
          <FilterDropdown
            ...
            onChange={(value) => {
              ...
              pushParams({ paymentStatus: value });
            }}
          />
      ...
      <section className="grid gap-3 md:grid-cols-[1fr]">
